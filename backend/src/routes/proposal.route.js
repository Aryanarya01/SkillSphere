...
import { acceptProposal, applyJob, getJobProposals, rejectProposal } from "../controllers/proposal.controller.js";
...
router.route("/proposal/reject/:id").put(Protect,authorizedRole("client"),rejectProposal)
